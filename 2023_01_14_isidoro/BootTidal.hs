...
-- scMap = ((superdirtTarget {oLatency = 1.0, oAddress = "127.0.0.1", oPort = 57120}),[superdirtShape])
-- tidal <- startStream (defaultConfig {cFrameTimespan = 1/20, cProcessAhead = 3/10}) [scMap]
